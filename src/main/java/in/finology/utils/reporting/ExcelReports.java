...
// This class is used to configure the Excel Report
public class ExcelReports extends Base {
    private static final Logger log = LogManager.getLogger(ExcelReports.class);

    // Write the given report data into the Excel file
